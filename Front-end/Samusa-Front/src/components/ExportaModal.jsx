  ...
  const handleSave = async () => {
    try {
      ...
      if (response.ok) {
        ...
        alert("Error al guardar, verifica los campos con *");
      ...
      alert("Verifica que el numero de seguimiento este rellenado");
      ...
      <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full animate__animated animate__fadeInUp">
          <div className="bg-blue-800 px-4 py-2 sm:px-6 rounded">
            {isEditing ? <h3 className="titleModal text-white">Editar Exportación
              </h3> : <h3 className="titleModal text-white">Agregar Exportación
              </h3>}
          </div>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
                ...
                <div className="mb-4">
                    ...
                    <select
                      name="revVehiculoId"
                      id="revVehiculoId"
                      value={editedExporta.revVehiculoId}
                      onChange={handleInputChange}
                      className="mt-1 p-2 border border-gray-300 rounded-md w-full"
                    >
                ...
                <div className="mb-4">
                    ...
                    <select
                      ...
                      id="revContenedorId"
                      value={editedExporta.revContenedorId}
                      onChange={handleInputChange}
                      className="mt-1 p-2 border border-gray-300 rounded-md w-full"
                    >
