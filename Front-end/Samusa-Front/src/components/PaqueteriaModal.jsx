    ...
    <div className="fixed z-10 inset-0 overflow-y-auto">
      <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
          ...
          {isEditing ? <h3 className="titleform">Editar paqueteria</h3> : <h3 className="titleform">Agregar paqueteria</h3>}
          </div>
          <br />
          <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
                ...
                <div>
                  ...
                  <input type="date" name="fechaEsperada" id="fechaEsperada" value={editedPaqueteria.fechaEsperada} onChange={handleInputChange} className="mt-1 p-2 border border-gray-300 rounded-md w-full" />
                </div>
                </div>
