...
const ClientModal = ({ user, onClose }) => {
  ...
  const handleSave = async () => {
    try {
      const response = await fetch('https://localhost:7293/api/samusa/cliente/modificar', {
        method: 'PUT',
        headers: {
      ...
      <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
          ...
          <div className="bg-indigo-600 px-4 py-4 sm:px-6">
            <h3 className="text-lg font-medium leading-6 text-white">Editar Usuario</h3>
          </div>
            ...
            <div className="sm:flex sm:items-start">
              ...
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <select name="rol" id="rol" value={editedUser.rol} onChange={handleInputChange} className="mt-1 p-2 border border-gray-300 rounded-md w-full">
